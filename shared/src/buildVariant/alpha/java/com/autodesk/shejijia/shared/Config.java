...
public class Config {
    ...
    public final static String MEMBER_APP_V2 = "http://alpha-api.gdfcx.net/member-app/v2/api";
    ...
    public final static String SHARE3_PATH = "http://alpha-api.gdfcx.net:8080/share/3dcase.html?caseid=";

 ...
 */
package com.autodesk.shejijia.shared.components.common.tools.zxing.view;
...
//            canvas.drawRect(frame.left, frame.bottom - 1, frame.right + 1, frame.bottom + 1, paint);
            ...
            //画扫描框边上的角，总共8个部分
            paint.setColor(getResources().getColor(R.color.zxing_corner));
...
//          canvas.drawRect(frame.left + MIDDLE_LINE_PADDING, slideTop - MIDDLE_LINE_WIDTH / 2, frame.right - MIDDLE_LINE_PADDING, slideTop + MIDDLE_LINE_WIDTH / 2, paint);
            ...
            /// TODO liuhe 将中间横线转为图片 .
            Rect lineRect = new Rect();
            lineRect.left = frame.left;
            lineRect.right = frame.right;
            lineRect.top = slideTop;
            lineRect.bottom = slideTop + 18;
            canvas.drawBitmap(((BitmapDrawable) (getResources().getDrawable(R.drawable.icon_scan_line))).getBitmap(), null, lineRect, paint);

...
public class SHFormConstant {
    ...
    public static class SHFormType{
        ...
        public static final String TYPE_COMPLETION = "type_completion";     //经理竣工巡检表
        public static final String TYPE_CONCEALED = "type_concealed";       //经理隐蔽工程验收巡检表
        public static final String TYPE_MIDDLE = "type_middle";             //经理中期验收巡检表
        ...
        public static final String TYPE_WATERPROOF = "type_waterproof";     //经理防水巡检表

...
/**
 * 自定义悬浮按钮，支持直接设置图片，包括图片的选中和费选中状态，没有设置时候，默认是plus
 */
public class FloatingActionMenu extends ViewGroup {
    ...
    private int mButtonSpacing = FloatingActionUtil.dpToPx(getContext(), 0f);
    private FloatingActionButton mMenuButton;
    private int mMaxButtonWidth;
    private int mLabelsMargin = FloatingActionUtil.dpToPx(getContext(), 0f);
    private int mLabelsVerticalOffset = FloatingActionUtil.dpToPx(getContext(), 0f);
    ...
    private int mLabelsPaddingTop = FloatingActionUtil.dpToPx(getContext(), 4f);
    private int mLabelsPaddingRight = FloatingActionUtil.dpToPx(getContext(), 8f);
    private int mLabelsPaddingBottom = FloatingActionUtil.dpToPx(getContext(), 4f);
    private int mLabelsPaddingLeft = FloatingActionUtil.dpToPx(getContext(), 8f);
    private ColorStateList mLabelsTextColor;
    private float mLabelsTextSize;
    private int mLabelsCornerRadius = FloatingActionUtil.dpToPx(getContext(), 3f);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLabelsTextSize = attr.getDimension(R.styleable.FloatingActionMenu_menu_labels_textSize, getResources().getDimension(R.dimen.size_14));
    ...
    private void initMenuButtonAnimations(TypedArray attr) {
        int showResId = attr.getResourceId(R.styleable.FloatingActionMenu_menu_fab_show_animation, R.anim.show_from_bottom);
        ...
        int hideResId = attr.getResourceId(R.styleable.FloatingActionMenu_menu_fab_hide_animation, R.anim.hide_to_bottom);
    ...
    private void createMenuButton() {
        ...
        if (mMenuShowShadow) {
            mMenuButton.mShadowRadius = FloatingActionUtil.dpToPx(getContext(), mMenuShadowRadius);
            mMenuButton.mShadowXOffset = FloatingActionUtil.dpToPx(getContext(), mMenuShadowXOffset);
            mMenuButton.mShadowYOffset = FloatingActionUtil.dpToPx(getContext(), mMenuShadowYOffset);
        }

...
import com.autodesk.shejijia.shared.components.common.uielements.reusewheel.adapter.NumericWheelAdapter;
...
import com.autodesk.shejijia.shared.components.common.uielements.reusewheel.utils.TimePickerViewIssue.Type;
...
public class WheelTimeIssue {
    ...
    public WheelTimeIssue(View view) {
        super();
        this.view = view;
        type = Type.ALL;
        setView(view);
    }
    public WheelTimeIssue(View view, Type type) {
        super();
        this.view = view;
        this.type = type;
        setView(view);

...
import com.autodesk.shejijia.shared.components.common.uielements.calanderview.format.ArrayWeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    protected CalendarMode calendarMode;
    /**
     * Used for the dynamic calendar height.
     */
    protected boolean mDynamicHeightEnabled;

    private final ArrayList<DayViewDecorator> dayViewDecorators = new ArrayList<>();

    protected CalendarDay minDate = null;
    protected CalendarDay maxDate = null;
    ...
    /**
     * Set a {@linkplain com.autodesk.shejijia.shared.components.common.uielements.calanderview.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see com.autodesk.shejijia.shared.components.common.uielements.calanderview.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(com.autodesk.shejijia.shared.components.common.uielements.calanderview.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain com.autodesk.shejijia.shared.components.common.uielements.calanderview.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see com.autodesk.shejijia.shared.components.common.uielements.calanderview.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(com.autodesk.shejijia.shared.components.common.uielements.calanderview.format.TitleFormatter)
     */
     ...
     */
    protected static int clampSize(int size, int spec) {

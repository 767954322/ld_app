...
//                mPresenter.cropImage(imageInfo);
    ...
    FolderItemListener mFolderItemClickListener = new FolderItemListener() {
        @Override
        public void onFolderItemClick(AlbumFolder folder) {
            mPresenter.switchFolder(folder);
        }
    };
...
//        Snackbar.make(getView(), message, Snackbar.LENGTH_SHORT).show();
        ToastUtils.showShort(mContext,message.toString());
    }
    ...
    public interface FolderItemListener {
        void onFolderItemClick(AlbumFolder folder);
    }

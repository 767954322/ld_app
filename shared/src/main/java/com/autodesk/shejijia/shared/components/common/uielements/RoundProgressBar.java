...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        //文字的颜色
        textColor = mTypedArray.getColor(R.styleable.RoundProgressBar_textColor_round, Color.GREEN);
        //文字的大小
        textSize = mTypedArray.getDimension(R.styleable.RoundProgressBar_textSize_round, 15);
        //圆环的宽度
        roundWidth = mTypedArray.getDimension(R.styleable.RoundProgressBar_roundWidth, 5);
        //最大进度
        max = mTypedArray.getInteger(R.styleable.RoundProgressBar_max_round, 100);
        //是否显示中间的进度
        ...
        // 圆形颜色
        backColor = mTypedArray.getColor(R.styleable.RoundProgressBar_backColor_round, 0);
        mTypedArray.recycle();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(centre, centre, radius*1.2f, paint); //画出圆环
        ...
        RectF oval = new RectF(centre - radius*1.2f, centre - radius*1.2f, centre
                + radius*1.2f, centre + radius*1.2f);  //用于定义的圆弧的形状和大小的界限

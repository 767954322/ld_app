...
import com.autodesk.shejijia.shared.components.common.tools.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    // Wheel drawables
    private int wheelBackground = R.drawable.wheel_bg_city;
    private int wheelForeground = R.drawable.wheel_val_city;
    ...
    private void initResourcesIfNecessary() {
        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_val_city);
        }
        ...
        setBackgroundResource(R.drawable.wheel_bg_city);
    }

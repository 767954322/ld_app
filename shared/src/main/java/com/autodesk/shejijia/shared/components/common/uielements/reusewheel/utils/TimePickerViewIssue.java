...
import com.autodesk.shejijia.shared.components.common.uielements.reusewheel.timepicker.WheelTimeIssue;
 ...
 */
public class TimePickerViewIssue extends BasePickerView implements View.OnClickListener {
    ...
    public TimePickerViewIssue(Context context, final Type type) {
        super(context);
        ...
        wheelTime = new WheelTimeIssue(timepickerview, type);
    ...
    private void isMatchCurrentTime() {
        ...
        try {
            Date date = WheelTimeIssue.dateFormat.parse(wheelTime.getTime());
//            currentTime = System.currentTimeMillis();
//            Long a = 3600*1000*2L;
//            currentTime = currentTime + a;
            if (justOnlyone) {
                dateCurrentTime = WheelTimeIssue.dateFormat.parse(wheelTime.getTime());

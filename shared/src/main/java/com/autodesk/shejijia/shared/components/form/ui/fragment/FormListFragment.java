...
//        SHPrecheckForm shPrecheckForm = (SHPrecheckForm) getArguments().getSerializable("shPrecheckForm");
        ...
        for (int i = 0; i < formTitles.size(); i++) {
            ...
            itemCell.setTitle(formTitles.get(i));
        ...
        mPresenter = new FormListPresenter(this,mActivity.getPresenter());
//        mPresenter.showFormList(mTask);
    ...
    public void enterFormItem(SHInspectionForm shInspectionForm) {
        ...
        mActivity.getSupportFragmentManager().beginTransaction()
                .hide(mActivity.getSupportFragmentManager().findFragmentByTag(mActivity.TAG_FORM_LIST_FRAGMENT))
                .add(R.id.fl_main_container, formSubListFragment, mActivity.TAG_FORM_SUBLIST_FRAGMENT)
                .addToBackStack(null)
                .commit();

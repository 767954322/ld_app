...
public class WkFlowStateAdapter extends BaseAdapter {
    ...
    public WkFlowStateAdapter(Context context, String member_type, WkFlowDetailsBean.RequirementEntity.BiddersEntity biddersEntity) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
         ...
         * 消费者全流程状态
         */
        if (member_type.equals(Constant.UerInfoKey.CONSUMER_TYPE)) { // 消费者
            switch (position) {
                case 0:
                    if (stateCode == 11) {
                ...
                case 1:
                    if (stateCode == 13) {
                        textColor = StepEnableColor;
                        viewHolder.piv_meal_phone.setImageDrawable(context.getResources().getDrawable(R.drawable.icon_liangfang));
                        ...
                        viewHolder.piv_meal_phone.setImageDrawable(context.getResources().getDrawable(R.drawable.liangfangfei_ico));
                        viewHolder.tv_meal_title.setText(UIUtils.getString(R.string.pay_amount_of_room_charge));
                ...
                case 2:
                    if (stateCode == 21) {
                        textColor = StepEnableColor;
                        viewHolder.piv_meal_phone.setImageDrawable(context.getResources().getDrawable(R.drawable.icon_jieshoushejihetong));
                        ...
                        textColor = StepDisEnableColor;
                        viewHolder.piv_meal_phone.setImageDrawable(context.getResources().getDrawable(R.drawable.jieshoushejihetong_ico));
                        viewHolder.tv_meal_title.setText(UIUtils.getString(R.string.jiesoushejiketong));
                        viewHolder.tv_meal_content.setText(UIUtils.getString(R.string.choose_designer_design_contract));
                    }
                    viewHolder.tv_meal_title.setTextColor(textColor);
                ...
                case 3:
                    if (stateCode == 31) {
                        textColor = StepEnableColor;
                        viewHolder.piv_meal_phone.setImageDrawable(context.getResources().getDrawable(R.drawable.icon_zhifushejishoukuan));
                        ...
                        textColor = StepDisEnableColor;
                        viewHolder.piv_meal_phone.setImageDrawable(context.getResources().getDrawable(R.drawable.shejishoukuan_ico));
                        viewHolder.tv_meal_title.setText(UIUtils.getString(R.string.zhifusheijiweikuan));
                        viewHolder.tv_meal_content.setText(UIUtils.getString(R.string.choose_designer_online_payment_first));
                    }
                    viewHolder.tv_meal_title.setTextColor(textColor);
                ...
                case 4:
                    if (stateCode == 41 || stateCode == 42) {
                        textColor = StepEnableColor;
                        viewHolder.piv_meal_phone.setImageDrawable(context.getResources().getDrawable(R.drawable.icon_zhifushejiweikuan));
                        ...
                        textColor = StepDisEnableColor;
                        viewHolder.piv_meal_phone.setImageDrawable(context.getResources().getDrawable(R.drawable.weikuan_ico));
                        viewHolder.tv_meal_title.setText(UIUtils.getString(R.string.zhifushejiket));
                        viewHolder.tv_meal_content.setText(UIUtils.getString(R.string.choose_designer_online_payment_balance_payment));
                    }
                    viewHolder.tv_meal_title.setTextColor(textColor);
                ...
                case 5:
                    if (stateCode == 51 || stateCode == 52) {
                        textColor = StepEnableColor;
                        viewHolder.piv_meal_phone.setImageDrawable(context.getResources().getDrawable(R.drawable.icon_jieshoushejijiaofuwu));
                        ...
                        textColor = StepDisEnableColor;
                        viewHolder.piv_meal_phone.setImageDrawable(context.getResources().getDrawable(R.drawable.jiaofuwu_ico));
                        viewHolder.tv_meal_title.setText(UIUtils.getString(R.string.jieshoujiafuwu));
        ...
        } else if (member_type.equals(Constant.UerInfoKey.DESIGNER_TYPE)) { // 设计师

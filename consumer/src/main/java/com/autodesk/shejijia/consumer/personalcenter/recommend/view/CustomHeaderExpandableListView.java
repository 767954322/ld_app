...
public class CustomHeaderExpandableListView extends ExpandableListView implements OnScrollListener,OnGroupClickListener {
	public CustomHeaderExpandableListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		registerListener();
	}

	public CustomHeaderExpandableListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		registerListener();
	}

	public CustomHeaderExpandableListView(Context context) {
		super(context);
		registerListener();
	}
	...
	private ExpandListHeaderInterface mAdapter;
	...
	public void setAdapter(ExpandableListAdapter adapter) {
		...
		mAdapter = (ExpandListHeaderInterface) adapter;
	}
	...
	public void configureHeaderView(int groupPosition, int childPosition) {
		...
		switch (state) {
			case ExpandListHeaderInterface.PINNED_HEADER_GONE: {
				mHeaderViewVisible = false;
				break;
			}
	
			case ExpandListHeaderInterface.PINNED_HEADER_VISIBLE: {
			...
			case ExpandListHeaderInterface.PINNED_HEADER_PUSHED_UP: {

...
import com.autodesk.shejijia.shared.components.common.uielements.alertview.AlertViewAdapter;
...
public class AlertViewUtil {
    ...
    public AlertViewUtil(String title, String msg, String cancel, String[] destructive, String[] others, Context context, Style style, OnItemClickListener onItemClickListener) {
        ...
        alertButtonListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                if (onItemClickListener != null)
                    onItemClickListener.onItemClick(AlertViewUtil.this, position);
                dismiss();
            }
        });
    }
    ...
    public AlertViewUtil addExtView(View extView) {
    ...
    public void dismiss() {
        ...
        if (onDismissListener != null) {
            onDismissListener.onDismiss(AlertViewUtil.this);
        }
    }

    public AlertViewUtil setOnDismissListener(OnDismissListener onDismissListener) {
    ...
    public AlertViewUtil setCancelable(boolean isCancelable) {

...
public class ActionSheetDialog {
    ...
    public ActionSheetDialog builder() {
        ...
        View view = LayoutInflater.from(context).inflate(
                R.layout.view_toast_actionsheet, null);

        /// Settings Dialog minimum width of the screen width .
    ...
    /**
     * @param strItem  entry name .
     * @param color    Entry font color, set null, the default blue .
     * @param listener
     */
    ...
    private void setSheetItems() {
        ...
        /// Height control, the best solution,Add entries when too much control level .
        if (size >= 7) {

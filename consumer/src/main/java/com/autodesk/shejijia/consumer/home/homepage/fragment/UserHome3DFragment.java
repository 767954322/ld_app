 ...
 * @brief 首页3D案例fragment, 展示案例 .
 */
public class UserHome3DFragment extends BaseFragment implements UserHome3DCaseAdapter.OnItemImageHeadClickListener,/* AbsListView.OnScrollListener,*/ View.OnClickListener {
    ...
    protected void initData() {
        mAdapter = new UserHome3DCaseAdapter(getActivity(), case3DBeanList, getActivity(), screenWidth, screenHeight);
...
////
    ...
    public void getCaseLibraryData(final String custom_string_style, final String custom_string_type, final String custom_string_keywords,
        ...
        MPServerHttpManager.getInstance().get3DCaseListData(custom_string_style, custom_string_type, custom_string_keywords,

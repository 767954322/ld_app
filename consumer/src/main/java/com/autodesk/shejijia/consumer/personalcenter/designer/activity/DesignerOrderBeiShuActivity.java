 ...
 */
public class DesignerOrderBeiShuActivity extends NavigationBarActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        mOrderContainer = (FrameLayout) findViewById(R.id.fl_designer_order_beishu_container);
        mBeishuOrder = (TextView) findViewById(R.id.tv_designer_order_beishu);

        mOrder = (TextView) findViewById(R.id.tv_designer_order);
    }
    ...
    private void setTvColor(TextView mOrder) {
        ...
        drawable.setStroke(UIUtils.dip2px(DesignerOrderBeiShuActivity.this, 1), UIUtils.getColor(R.color.bg_0084ff));

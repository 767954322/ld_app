...
import com.autodesk.shejijia.consumer.home.widget.entity.TabEntity;
import com.autodesk.shejijia.consumer.home.widget.listener.OnTabSelectListener;
import com.autodesk.shejijia.consumer.home.widget.utils.FragmentChangeManager;
import com.autodesk.shejijia.consumer.home.widget.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private int mItemLayout = -1;//自己引入的布局
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mIconGravity == Gravity.LEFT) {
                ...
                if (mItemLayout != -1) {
                    tabView = View.inflate(mContext, mItemLayout, null);
                } else {
    ...
    private void addTab(final int position, View tabView) {
        ...
        iv_tab_icon.setBackgroundResource(mTabEntitys.get(position).getTabUnselectedIcon());
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
            ...
            if (mIconVisible) {
                ...
                if (tabEntity.getIconHeight() != 0 && tabEntity.getIconWidth() != 0) {
                    mIconWidth = tabEntity.getIconWidth();
                    mIconHeight = tabEntity.getIconHeight();
                } else {
                    mIconWidth = 0;
                    mIconHeight = 0;
                }
